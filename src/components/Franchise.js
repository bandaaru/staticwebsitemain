    ...
    <div className="franchise-page">
      ...
      <section className="franchise-section">
        <div className="section-container">
          ...
          <h2 className="section-title">{t("franchise_partner_title")}</h2>
          ...
          <div className="feature-row">
            ...
            <div className="feature-box image-box">
              <img
                src="https://media.istockphoto.com/id/1316735334/photo/young-indian-farmer-with-agronomist-at-banana-field.jpg?s=612x612&w=0&k=20&c=SjD-Bi-oO9LsYUSB69Jphal7nB-DySGiwLb8aDnw8UI="
                alt="Agri Professional"
              />
            </div>

            <div className="feature-box content-box">
              <span className="highlight-text">
                {t("franchise_partner_prof_title")}
              </span>
          ...
          <div className="feature-row reverse">
            ...
            <div className="feature-box image-box">
              <img
                src="https://www.balavikasa.org/uploads/blogs/1500-organic-farmers-gather-for-monthly-meetings-on-organic-farming-practices193.jpg"
                alt="Strong Network"
              />
            </div>
          ...
          <div className="feature-row">
            ...
            <div className="feature-box image-box">
              <img
                src="https://media.licdn.com/dms/image/v2/C5622AQHUhmurCxul1Q/feedshare-shrink_1280/feedshare-shrink_1280/0/1591079576697?e=1775088000&v=beta&t=ogGDsUPnprEsIjf4rQD4O-z_AD3RvwRv0SsPjZwnEPI"
                alt="Retail Ready"
              />
            </div>
            ...
            <div className="feature-box content-box">
              <span className="highlight-text">
                {t("franchise_partner_retail_title")}
              </span>
          ...
          <div className="feature-row reverse">
            ...
            <div className="feature-box image-box">
              <img
                src="https://th-i.thgim.com/public/incoming/wp5hlb/article70715309.ece/alternates/FREE_1200/10215_7_3_2026_12_40_41_1_IMG_20260307_WA0085.JPG"
                alt="Compliance"
              />
            </div>
            ...
            <div className="feature-box content-box">
              <span className="highlight-text">
                {t("franchise_partner_comp_title")}
              </span>
      ...
      <section className="perks-section">
        <div className="section-container">
          ...
          <h2 className="perks-title">
            {t("franchise_perks_title")}
          </h2>

          <p className="section-subtitle">
            {t("franchise_perks_subtitle")}
          </p>
          ...
          <div className="perks-grid">
            ...
            <div className="perks-card">
              <img
                src="https://media.licdn.com/dms/image/v2/D5622AQFjHGIlr-e1oA/feedshare-shrink_2048_1536/B56ZmmIHP8JkA0-/0/1759428772680?e=1775088000&v=beta&t=wZCEnV_AJRAr9e_LaZsfeTUJYdS09mSIR-GMZyYdPsk"
            ...
            <div className="perks-card">
              <img
                src="https://content.jdmagicbox.com/comp/def_content/warehouses-for-food-products/warehouses-for-food-products-5-warehouses-for-food-products-5-lk8r4.jpg"
                alt="Agriculture Warehouse"
              />
            ...
            <div className="perks-card">
              <img
                src="https://cdn.assets.prezly.com/fb68b75b-7558-4590-8737-ae8e60f9ac96/IMG_2969.jpeg"
                alt="Farmer Training"
              />
            ...
            <div className="perks-card">
              <img
                src="https://media.licdn.com/dms/image/v2/C4D22AQEcdFMC3KuvVw/feedshare-shrink_2048_1536/feedshare-shrink_2048_1536/0/1576187950641?e=1775088000&v=beta&t=UpGJE24kZzKjT2sZVcbppzQq9OnC8n_ulDNmX4dpfcc"
                alt="Agri Product Promotion"
              />
